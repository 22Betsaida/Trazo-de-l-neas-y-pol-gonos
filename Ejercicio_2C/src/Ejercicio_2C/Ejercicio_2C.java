...
public class Ejercicio_2C implements GLEventListener {
    static GLU glu;
    static GL gl;
    static JFrame frame;
...
public static void main(String[] args) {  
      ...
      canvas.addGLEventListener(new Ejercicio_2C());
      frame.add(canvas);
            ...
            public void mouseClicked(MouseEvent e) {
                 if(cont==lados){
                     try {
                         ...
                         Logger.getLogger(Ejercicio_2C.class.getName()).log(Level.SEVERE, null, ex);
                     }
                    reiniciar();
                }
            }
